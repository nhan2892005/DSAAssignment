/*
    ...
    * Version 2.1
    * This file defines array list
    * Final test and update for Array List
*/
...
protected:
    void isValidIndex(int index);     // * check validity of index for accessing
...
//////////////////////////////////////////////////////////////////////
template <class T>
void XArrayList<T>::isValidIndex(int index)
{
    /*
