...
xmap<string, TensorDataset<double, double>*>* DSFactory::get_datasets_3cc(){
    ...
    string train_file = (ds_path / fs::path("3c_train.npy")).string();
    string valid_file = (ds_path / fs::path("3c_valid.npy")).string();
    string test_file = (ds_path / fs::path("3c_test.npy")).string();
